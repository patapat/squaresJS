(function () {
  ...
  GameView.prototype.startGame = function () {
    ...
    this.canvasEl.removeEventListener('click', this.buttonInteraction);
    this.canvasEl.removeEventListener('mousemove', this.buttonInteraction);
    Squares.Game.OVER = false;
  }

  function buttonInteraction(event) {
    var button = this.playButtonSensor;
    if (this.gameIsOver) {
      button = this.restartButtonSensor;
    }
  ...
  GameView.prototype.renderScore = function () {
    ...
    this.ctx.fillText("Score:" + this.game.score + " Squares:" + this.game.squareScore, this.game.dimX / 2 - 130, this.game.dimY / 2 - 50)
  }
  ...
  GameView.prototype.gameOver = function () {
    ...
    this.renderPlayButton("black", this.restartButtonSensor);
    this.renderScore();
    this.canvasEl.addEventListener('click', this.buttonInteraction.bind(this));
    this.canvasEl.addEventListener('mousemove', this.buttonInteraction.bind(this));
    this.canvasEl.removeEventListener('click', this.buttonInteraction.bind(this));
    this.canvasEl.removeEventListener('mousemove', this.buttonInteraction.bind(this));
  }
